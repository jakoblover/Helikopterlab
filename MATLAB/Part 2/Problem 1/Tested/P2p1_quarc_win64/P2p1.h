 ...
 */
#ifndef RTW_HEADER_P2p1_h_
#define RTW_HEADER_P2p1_h_
#include <stddef.h>
#include <string.h>
#ifndef P2p1_COMMON_INCLUDES_
# define P2p1_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P2p1_COMMON_INCLUDES_ */

#include "P2p1_types.h"
...
#define P2p1_rtModel                   RT_MODEL_P2p1_T
...
#define rtB                            P2p1_B
#define BlockIO                        B_P2p1_T
#define rtX                            P2p1_X
#define ContinuousStates               X_P2p1_T
#define rtXdot                         P2p1_XDot
#define StateDerivatives               XDot_P2p1_T
#define tXdis                          P2p1_XDis
#define StateDisabled                  XDis_P2p1_T
#define rtP                            P2p1_P
#define Parameters                     P_P2p1_T
#define rtDWork                        P2p1_DW
#define D_Work                         DW_P2p1_T
...
struct P_P2p1_T_ {
  ...
  real_T Integrator_LowerSat;          /* Expression: -inf
                                        * Referenced by: '<S6>/Integrator'
                                        */
  real_T ReferenceElevation_Value;     /* Expression: 0
                                        * Referenced by: '<Root>/Reference Elevation'
                                        */
...
extern P_P2p1_T P2p1_P;

/* Block signals (auto storage) */
extern B_P2p1_T P2p1_B;

/* Continuous states (auto storage) */
extern X_P2p1_T P2p1_X;

/* Block states (auto storage) */
extern DW_P2p1_T P2p1_DW;

/* Model entry point functions */
extern void P2p1_initialize(void);
extern void P2p1_output(void);
extern void P2p1_update(void);
extern void P2p1_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P2p1_T *const P2p1_M;
 ...
 * '<Root>' : 'P2p1'
 * '<S1>'   : 'P2p1/Conversion'
 * '<S2>'   : 'P2p1/Elevation controller'
 * '<S3>'   : 'P2p1/Heli 3D'
 * '<S4>'   : 'P2p1/Joystick'
 * '<S5>'   : 'P2p1/Pitch controller'
 * '<S6>'   : 'P2p1/Elevation controller/Elevation controller'
 * '<S7>'   : 'P2p1/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'P2p1/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'P2p1/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'P2p1/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'P2p1/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'P2p1/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P2p1_h_ */
