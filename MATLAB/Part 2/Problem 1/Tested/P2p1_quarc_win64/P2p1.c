...
void P2p1_output(void)
{
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    /* S-Function Block: P2p1/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_DeadZoney = P2p1_DW.HILReadEncoderTimebase_Buffer[1];
        rtb_Sum_mn = P2p1_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }

    /* Gain: '<S3>/Pitch: Count to rad' */
    P2p1_B.PitchCounttorad = P2p1_P.PitchCounttorad_Gain * rtb_DeadZoney;

    /* Gain: '<S3>/Deg to Rad   ' incorporates:
     *  Gain: '<S9>/Gain'
     */
    P2p1_B.DegtoRad = P2p1_P.Gain_Gain * P2p1_B.PitchCounttorad *
   ...
   */
  P2p1_B.DegtoRad_o = (P2p1_P.PitchTransferFcn_C *
                       P2p1_X.PitchTransferFcn_CSTATE +
                       P2p1_P.PitchTransferFcn_D * P2p1_B.PitchCounttorad) *
    P2p1_P.Gain_Gain_c * P2p1_P.DegtoRad_Gain_m;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Gain: '<S3>/Elevation: Count to rad' */
    P2p1_B.ElevationCounttorad = P2p1_P.ElevationCounttorad_Gain * rtb_Sum_mn;
     ...
     *  Sum: '<S3>/Sum'
     */
    P2p1_B.DegtoRad_oh = (P2p1_P.Gain_Gain_i * P2p1_B.ElevationCounttorad +
                          P2p1_P.Constant_Value) * P2p1_P.DegtoRad_Gain_k;
  }
   ...
   */
  P2p1_B.DegtoRad_i = (P2p1_P.ElevationTransferFcn_C *
                       P2p1_X.ElevationTransferFcn_CSTATE +
                       P2p1_P.ElevationTransferFcn_D *
                       P2p1_B.ElevationCounttorad) * P2p1_P.Gain_Gain_o *
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
     ...
     *  Gain: '<S11>/Gain'
     */
    P2p1_B.DegtoRad_l = P2p1_P.Gain_Gain_k * P2p1_B.TravelCounttorad *
   ...
   */
  P2p1_B.DegtoRad_j = (P2p1_P.TravelTransferFcn_C *
                       P2p1_X.TravelTransferFcn_CSTATE +
                       P2p1_P.TravelTransferFcn_D * P2p1_B.TravelCounttorad) *
    P2p1_P.Gain_Gain_b * P2p1_P.DegtoRad_Gain_f;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* SignalConversion: '<Root>/TmpSignal ConversionAtTo FileInport1' */
    rtb_TmpSignalConversionAtToFile[0] = P2p1_B.DegtoRad;
    rtb_TmpSignalConversionAtToFile[1] = P2p1_B.DegtoRad_o;
    rtb_TmpSignalConversionAtToFile[2] = P2p1_B.DegtoRad_oh;
    rtb_TmpSignalConversionAtToFile[3] = P2p1_B.DegtoRad_i;
    rtb_TmpSignalConversionAtToFile[4] = P2p1_B.DegtoRad_l;
    rtb_TmpSignalConversionAtToFile[5] = P2p1_B.DegtoRad_j;

    /* ToFile: '<Root>/To File' */
    {
      if (!(++P2p1_DW.ToFile_IWORK.Decimation % 1) &&
          (P2p1_DW.ToFile_IWORK.Count*7)+1 < 100000000 ) {
        FILE *fp = (FILE *) P2p1_DW.ToFile_PWORK.FilePtr;
        if (fp != (NULL)) {
          real_T u[7];
          P2p1_DW.ToFile_IWORK.Decimation = 0;
          ...
          if (fwrite(u, sizeof(real_T), 7, fp) != 7) {
            rtmSetErrorStatus(P2p1_M, "Error writing to MAT-file var.mat");
            return;
          }

          if (((++P2p1_DW.ToFile_IWORK.Count)*7)+1 >= 100000000) {
            (void)fprintf(stdout,
    ...
    if (rtb_Sum_mn > P2p1_P.DeadZonex_End) {
      rtb_Sum_mn -= P2p1_P.DeadZonex_End;
    } else if (rtb_Sum_mn >= P2p1_P.DeadZonex_Start) {
      rtb_Sum_mn = 0.0;
    } else {
      rtb_Sum_mn -= P2p1_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S4>/Gain: x'
     */
    P2p1_B.Joystick_gain_x = P2p1_P.Gainx_Gain * rtb_Sum_mn *
      P2p1_P.Joystick_gain_x;

    /* DeadZone: '<S4>/Dead Zone: y' */
    if (rtb_DeadZoney > P2p1_P.DeadZoney_End) {
      rtb_DeadZoney -= P2p1_P.DeadZoney_End;
    } else if (rtb_DeadZoney >= P2p1_P.DeadZoney_Start) {
      rtb_DeadZoney = 0.0;
    } else {
      rtb_DeadZoney -= P2p1_P.DeadZoney_Start;
    }
    ...
    rtb_TmpSignalConversionAtToFi_n[0] = P2p1_B.Joystick_gain_x;
    rtb_TmpSignalConversionAtToFi_n[1] = P2p1_B.Joystick_gain_y;
      ...
      if (!(++P2p1_DW.ToFile1_IWORK.Decimation % 1) &&
        ...
        if (fp != (NULL)) {
          ...
          if (fwrite(u, sizeof(real_T), 3, fp) != 3) {
            rtmSetErrorStatus(P2p1_M, "Error writing to MAT-file joystick.mat");
            return;
          }
     ...
     *  Sum: '<S5>/Sum'
     */
    P2p1_B.Gain = (P2p1_P.Gain1_Gain * P2p1_B.Joystick_gain_x - P2p1_B.DegtoRad)
      * P2p1_P.k_pp;
  }
   ...
   *  Gain: '<S5>/Gain1'
   */
  rtb_Frontgain = P2p1_B.Gain - P2p1_P.k_pd * P2p1_B.DegtoRad_o;
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
     ...
     *  Constant: '<Root>/Reference Elevation'
     */
    rtb_Sum_mn = P2p1_P.ReferenceElevation_Value - P2p1_B.DegtoRad_oh;

    /* Gain: '<S6>/K_ep' */
    P2p1_B.K_ep = P2p1_P.K_ep_Gain * rtb_Sum_mn;
  }
   ...
   *  Sum: '<S6>/Sum'
   */
  rtb_Backgain = ((rtb_Backgain + P2p1_B.K_ep) - P2p1_P.K_ed_Gain *
                  P2p1_B.DegtoRad_i) + -P2p1_P.l_2 / P2p1_P.l_3;
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Gain: '<S6>/K_ei' */
    P2p1_B.K_ei = P2p1_P.K_ei_Gain * rtb_Sum_mn;
  }

  /* Gain: '<S1>/Front gain' */
  rtb_Frontgain = P2p1_P.Frontgain_Gain * rtb_Add;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (rtb_Frontgain > P2p1_P.FrontmotorSaturation_UpperSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Frontgain < P2p1_P.FrontmotorSaturation_LowerSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_LowerSat;
  } else {
    P2p1_B.FrontmotorSaturation = rtb_Frontgain;
  }
...
void P2p1_initialize(void)
{
  ...
  /* S-Function Block: P2p1/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((P2p1_P.HILInitialize_set_analog_input_ && !is_switching) ||
        (P2p1_P.HILInitialize_set_analog_inpu_o && is_switching)) {
      {
        int_T i1;
    ...
    if ((P2p1_P.HILInitialize_set_analog_output && !is_switching) ||
        (P2p1_P.HILInitialize_set_analog_outp_d && is_switching)) {
      {
        int_T i1;
    ...
    if ((P2p1_P.HILInitialize_set_analog_outp_e && !is_switching) ||
        (P2p1_P.HILInitialize_set_analog_outp_k && is_switching)) {
      {
        int_T i1;
    ...
    if (P2p1_P.HILInitialize_set_analog_outp_o) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &P2p1_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((P2p1_P.HILInitialize_set_encoder_param && !is_switching) ||
        (P2p1_P.HILInitialize_set_encoder_par_k && is_switching)) {
      {
        int_T i1;
    ...
    if ((P2p1_P.HILInitialize_set_encoder_count && !is_switching) ||
        (P2p1_P.HILInitialize_set_encoder_cou_g && is_switching)) {
      {
        int_T i1;
    ...
    if ((P2p1_P.HILInitialize_set_pwm_params_at && !is_switching) ||
        (P2p1_P.HILInitialize_set_pwm_params__m && is_switching)) {
    ...
    if ((P2p1_P.HILInitialize_set_pwm_outputs_a && !is_switching) ||
        (P2p1_P.HILInitialize_set_pwm_outputs_c && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &P2p1_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
  ...
  /* Start for ToFile: '<Root>/To File' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P2p1_M, "Error creating .mat file var.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,7,0,"var")) {
      rtmSetErrorStatus(P2p1_M, "Error writing mat file header to file var.mat");
      return;
    }

    P2p1_DW.ToFile_IWORK.Count = 0;
    P2p1_DW.ToFile_IWORK.Decimation = -1;
    P2p1_DW.ToFile_PWORK.FilePtr = fp;
  }
  ...
  /* Start for ToFile: '<Root>/To File1' */
  {
    ...
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P2p1_M, "Error creating .mat file joystick.mat");
      return;
    }
...
void P2p1_terminate(void)
{
  ...
  /* S-Function Block: P2p1/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    if ((P2p1_P.HILInitialize_set_analog_outp_l && !is_switching) ||
        (P2p1_P.HILInitialize_set_analog_outp_h && is_switching)) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &P2p1_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((P2p1_P.HILInitialize_set_pwm_outputs_g && !is_switching) ||
        (P2p1_P.HILInitialize_set_pwm_output_c4 && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &P2p1_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "var.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P2p1_M, "Error closing MAT-file var.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P2p1_M, "Error reopening MAT-file var.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 7, P2p1_DW.ToFile_IWORK.Count, "var")) {
        rtmSetErrorStatus(P2p1_M,
      ...
      P2p1_DW.ToFile_PWORK.FilePtr = (NULL);
    }
  }
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "joystick.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P2p1_M, "Error closing MAT-file joystick.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P2p1_M, "Error reopening MAT-file joystick.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 3, P2p1_DW.ToFile1_IWORK.Count,
           "joystick_output")) {
        rtmSetErrorStatus(P2p1_M,
...
RT_MODEL_P2p1_T *P2p1(void)
{
  ...
  /* Initialize timing info */
  {
    ...
    P2p1_M->Timing.sampleTimes[1] = (0.01);
  ...
  P2p1_M->Timing.stepSize0 = 0.01;
  P2p1_M->Timing.stepSize1 = 0.01;

  /* External mode info */
  P2p1_M->Sizes.checksums[0] = (1903338898U);
  P2p1_M->Sizes.checksums[1] = (2884678206U);
  P2p1_M->Sizes.checksums[2] = (2957182908U);
  P2p1_M->Sizes.checksums[3] = (1550036936U);
  ...
  P2p1_M->Timing.stepSize = (0.01);
  rtsiSetFixedStepSize(&P2p1_M->solverInfo, 0.01);
  rtsiSetSolverMode(&P2p1_M->solverInfo, SOLVER_MODE_SINGLETASKING);
...

  {
    ...
    P2p1_B.DegtoRad = 0.0;
    P2p1_B.DegtoRad_o = 0.0;
    P2p1_B.ElevationCounttorad = 0.0;
    P2p1_B.DegtoRad_oh = 0.0;
    P2p1_B.DegtoRad_i = 0.0;
    P2p1_B.TravelCounttorad = 0.0;
    P2p1_B.DegtoRad_l = 0.0;
    P2p1_B.DegtoRad_j = 0.0;
  ...
  P2p1_M->Sizes.numSampTimes = (2);    /* Number of sample times */
  P2p1_M->Sizes.numBlocks = (62);      /* Number of blocks */
  P2p1_M->Sizes.numBlockIO = (16);     /* Number of block outputs */
  P2p1_M->Sizes.numBlockPrms = (158);  /* Sum of parameter "widths" */
  return P2p1_M;
}
