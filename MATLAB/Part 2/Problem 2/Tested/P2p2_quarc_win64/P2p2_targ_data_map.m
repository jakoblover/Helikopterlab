  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P2p2_P.HILInitialize_set_other_outpu_i
	  ...
	  ;% P2p2_P.HILInitialize_set_other_outpu_o
	  ...
	  ;% P2p2_P.HILInitialize_set_analog_inpu_o
	  ...
	  ;% P2p2_P.HILInitialize_set_analog_outp_d
	  ...
	  ;% P2p2_P.HILInitialize_set_analog_outp_k
	  section.data(9).logicalSrcIdx = 48;
	  section.data(9).dtTransOffset = 8;
	
	  ;% P2p2_P.HILInitialize_set_analog_outp_h
	  section.data(10).logicalSrcIdx = 49;
	  section.data(10).dtTransOffset = 9;
	
	  ;% P2p2_P.HILInitialize_set_analog_outp_l
	  section.data(11).logicalSrcIdx = 50;
	  section.data(11).dtTransOffset = 10;
	
	  ;% P2p2_P.HILInitialize_set_analog_outp_o
	  ...
	  ;% P2p2_P.HILInitialize_set_clock_frequ_l
	  ...
	  ;% P2p2_P.HILInitialize_set_clock_param_a
	  ...
	  ;% P2p2_P.HILInitialize_set_digital_out_p
	  section.data(20).logicalSrcIdx = 59;
	  section.data(20).dtTransOffset = 19;
	
	  ;% P2p2_P.HILInitialize_set_digital_out_g
	  section.data(21).logicalSrcIdx = 60;
	  section.data(21).dtTransOffset = 20;
	
	  ;% P2p2_P.HILInitialize_set_digital_ou_gs
	  section.data(22).logicalSrcIdx = 61;
	  section.data(22).dtTransOffset = 21;
	
	  ;% P2p2_P.HILInitialize_set_digital_ou_pm
	  ...
	  ;% P2p2_P.HILInitialize_set_encoder_cou_g
	  ...
	  ;% P2p2_P.HILInitialize_set_encoder_par_k
	  section.data(27).logicalSrcIdx = 66;
	  section.data(27).dtTransOffset = 26;
	
	  ;% P2p2_P.HILInitialize_set_other_outp_kp
	  ...
	  ;% P2p2_P.HILInitialize_set_pwm_outputs_c
	  section.data(30).logicalSrcIdx = 69;
	  section.data(30).dtTransOffset = 29;
	
	  ;% P2p2_P.HILInitialize_set_pwm_output_c4
	  ...
	  ;% P2p2_P.HILInitialize_set_pwm_params__m
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P2p2_DW.ToFile1_PWORK.FilePtr
	  section.data(2).logicalSrcIdx = 13;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P2p2_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 14;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P2p2_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 15;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P2p2_DW.PitchScoperad_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 16;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P2p2_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 17;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P2p2_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P2p2_DW.TravelScoperad_PWORK.LoggedData
  ...
  targMap.checksum0 = 906022945;
  targMap.checksum1 = 3053244993;
  targMap.checksum2 = 1918010593;
  targMap.checksum3 = 827604092;
