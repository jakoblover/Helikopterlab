  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P3p3_P.HILInitialize_set_other_outpu_i
	  ...
	  ;% P3p3_P.HILInitialize_set_other_outpu_o
	  ...
	  ;% P3p3_P.HILInitialize_set_analog_inpu_o
	  ...
	  ;% P3p3_P.HILInitialize_set_analog_outp_d
	  ...
	  ;% P3p3_P.HILInitialize_set_analog_outp_k
	  section.data(9).logicalSrcIdx = 47;
	  section.data(9).dtTransOffset = 8;
	
	  ;% P3p3_P.HILInitialize_set_analog_outp_h
	  section.data(10).logicalSrcIdx = 48;
	  section.data(10).dtTransOffset = 9;
	
	  ;% P3p3_P.HILInitialize_set_analog_outp_l
	  section.data(11).logicalSrcIdx = 49;
	  section.data(11).dtTransOffset = 10;
	
	  ;% P3p3_P.HILInitialize_set_analog_outp_o
	  ...
	  ;% P3p3_P.HILInitialize_set_clock_frequ_l
	  ...
	  ;% P3p3_P.HILInitialize_set_clock_param_a
	  ...
	  ;% P3p3_P.HILInitialize_set_digital_out_p
	  section.data(20).logicalSrcIdx = 58;
	  section.data(20).dtTransOffset = 19;
	
	  ;% P3p3_P.HILInitialize_set_digital_out_g
	  section.data(21).logicalSrcIdx = 59;
	  section.data(21).dtTransOffset = 20;
	
	  ;% P3p3_P.HILInitialize_set_digital_ou_gs
	  section.data(22).logicalSrcIdx = 60;
	  section.data(22).dtTransOffset = 21;
	
	  ;% P3p3_P.HILInitialize_set_digital_ou_pm
	  ...
	  ;% P3p3_P.HILInitialize_set_encoder_cou_g
	  ...
	  ;% P3p3_P.HILInitialize_set_encoder_par_k
	  section.data(27).logicalSrcIdx = 65;
	  section.data(27).dtTransOffset = 26;
	
	  ;% P3p3_P.HILInitialize_set_other_outp_kp
	  ...
	  ;% P3p3_P.HILInitialize_set_pwm_outputs_c
	  section.data(30).logicalSrcIdx = 68;
	  section.data(30).dtTransOffset = 29;
	
	  ;% P3p3_P.HILInitialize_set_pwm_output_c4
	  ...
	  ;% P3p3_P.HILInitialize_set_pwm_params__m
	  ...
	  ;% P3p3_P.Constant_Value
	  section.data(11).logicalSrcIdx = 84;
	  section.data(11).dtTransOffset = 10;
	
	  ;% P3p3_P.DegtoRad_Gain_k
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P3p3_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P3p3_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% P3p3_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% P3p3_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 24;
	
	  ;% P3p3_DW.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 32;
	
	  ;% P3p3_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% P3p3_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 48;
	
	  ;% P3p3_DW.HILInitialize_POValues
	  section.data(8).logicalSrcIdx = 7;
	  ...
	  ;% P3p3_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 14;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P3p3_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 15;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P3p3_DW.PitchScoperad_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 16;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P3p3_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 17;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P3p3_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P3p3_DW.TravelScoperad_PWORK.LoggedData
  ...
  targMap.checksum0 = 898081371;
  targMap.checksum1 = 3127279091;
  targMap.checksum2 = 1479729481;
  targMap.checksum3 = 1527005861;
