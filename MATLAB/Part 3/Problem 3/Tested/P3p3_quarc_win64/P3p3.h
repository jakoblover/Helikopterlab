 ...
 */
#ifndef RTW_HEADER_P3p3_h_
#define RTW_HEADER_P3p3_h_
#include <stddef.h>
#include <string.h>
#ifndef P3p3_COMMON_INCLUDES_
# define P3p3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P3p3_COMMON_INCLUDES_ */

#include "P3p3_types.h"
...
#define P3p3_rtModel                   RT_MODEL_P3p3_T
...
#define rtB                            P3p3_B
#define BlockIO                        B_P3p3_T
#define rtX                            P3p3_X
#define ContinuousStates               X_P3p3_T
#define rtXdot                         P3p3_XDot
#define StateDerivatives               XDot_P3p3_T
#define tXdis                          P3p3_XDis
#define StateDisabled                  XDis_P3p3_T
#define rtP                            P3p3_P
#define Parameters                     P_P3p3_T
#define rtDWork                        P3p3_DW
#define D_Work                         DW_P3p3_T
...
extern P_P3p3_T P3p3_P;

/* Block signals (auto storage) */
extern B_P3p3_T P3p3_B;

/* Continuous states (auto storage) */
extern X_P3p3_T P3p3_X;

/* Block states (auto storage) */
extern DW_P3p3_T P3p3_DW;

/* Model entry point functions */
extern void P3p3_initialize(void);
extern void P3p3_output(void);
extern void P3p3_update(void);
extern void P3p3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P3p3_T *const P3p3_M;
 ...
 * '<S2>'   : 'P3p3/Heli 3D'
 * '<S3>'   : 'P3p3/Joystick'
 * '<S4>'   : 'P3p3/LQR controller'
 * '<S5>'   : 'P3p3/Heli 3D/Elevation rad to deg'
 * '<S6>'   : 'P3p3/Heli 3D/Elevation rate rad to deg'
 * '<S7>'   : 'P3p3/Heli 3D/Pitch rad to deg'
 * '<S8>'   : 'P3p3/Heli 3D/Pitch rate rad to deg'
 * '<S9>'   : 'P3p3/Heli 3D/Travel rad to deg'
 * '<S10>'  : 'P3p3/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P3p3_h_ */
