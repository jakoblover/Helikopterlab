...
#endif                                 /* P3p2_COMMON_INCLUDES_ */

#include "P3p2_types.h"
...
#define P3p2_rtModel                   RT_MODEL_P3p2_T
...
#define rtB                            P3p2_B
#define BlockIO                        B_P3p2_T
#define rtX                            P3p2_X
#define ContinuousStates               X_P3p2_T
#define rtXdot                         P3p2_XDot
#define StateDerivatives               XDot_P3p2_T
#define tXdis                          P3p2_XDis
#define StateDisabled                  XDis_P3p2_T
#define rtP                            P3p2_P
#define Parameters                     P_P3p2_T
#define rtDWork                        P3p2_DW
#define D_Work                         DW_P3p2_T
...
extern P_P3p2_T P3p2_P;

/* Block signals (auto storage) */
extern B_P3p2_T P3p2_B;

/* Continuous states (auto storage) */
extern X_P3p2_T P3p2_X;

/* Block states (auto storage) */
extern DW_P3p2_T P3p2_DW;

/* Model entry point functions */
extern void P3p2_initialize(void);
extern void P3p2_output(void);
extern void P3p2_update(void);
extern void P3p2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P3p2_T *const P3p2_M;
 ...
 * '<S2>'   : 'P3p2/Heli 3D'
 * '<S3>'   : 'P3p2/Joystick'
 * '<S4>'   : 'P3p2/LQR controller'
 * '<S5>'   : 'P3p2/Heli 3D/Elevation rad to deg'
 * '<S6>'   : 'P3p2/Heli 3D/Elevation rate rad to deg'
 * '<S7>'   : 'P3p2/Heli 3D/Pitch rad to deg'
 * '<S8>'   : 'P3p2/Heli 3D/Pitch rate rad to deg'
 * '<S9>'   : 'P3p2/Heli 3D/Travel rad to deg'
 * '<S10>'  : 'P3p2/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P3p2_h_ */
