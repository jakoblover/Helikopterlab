  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P3p2_P.HILInitialize_set_other_outpu_i
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 26;
	
	  ;% P3p2_P.HILInitialize_set_other_outpu_k
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 27;
	
	  ;% P3p2_P.HILInitialize_set_other_outpu_o
	  ...
	  ;% P3p2_P.HILInitialize_set_analog_inpu_o
	  ...
	  ;% P3p2_P.HILInitialize_set_analog_outp_d
	  section.data(7).logicalSrcIdx = 45;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P3p2_P.HILInitialize_set_analog_outp_e
	  section.data(8).logicalSrcIdx = 46;
	  section.data(8).dtTransOffset = 7;
	
	  ;% P3p2_P.HILInitialize_set_analog_outp_k
	  ...
	  ;% P3p2_P.HILInitialize_set_analog_outp_o
	  ...
	  ;% P3p2_P.HILInitialize_set_clock_frequ_l
	  ...
	  ;% P3p2_P.HILInitialize_set_clock_param_a
	  ...
	  ;% P3p2_P.HILInitialize_set_digital_out_a
	  section.data(19).logicalSrcIdx = 57;
	  section.data(19).dtTransOffset = 18;
	
	  ;% P3p2_P.HILInitialize_set_digital_out_p
	  section.data(20).logicalSrcIdx = 58;
	  section.data(20).dtTransOffset = 19;
	
	  ;% P3p2_P.HILInitialize_set_digital_out_g
	  section.data(21).logicalSrcIdx = 59;
	  section.data(21).dtTransOffset = 20;
	
	  ;% P3p2_P.HILInitialize_set_digital_ou_gs
	  section.data(22).logicalSrcIdx = 60;
	  section.data(22).dtTransOffset = 21;
	
	  ;% P3p2_P.HILInitialize_set_digital_ou_pm
	  ...
	  ;% P3p2_P.HILInitialize_set_encoder_cou_g
	  ...
	  ;% P3p2_P.HILInitialize_set_encoder_par_k
	  section.data(27).logicalSrcIdx = 65;
	  section.data(27).dtTransOffset = 26;
	
	  ;% P3p2_P.HILInitialize_set_other_outp_kp
	  ...
	  ;% P3p2_P.HILInitialize_set_pwm_output_c4
	  section.data(31).logicalSrcIdx = 69;
	  section.data(31).dtTransOffset = 30;
	
	  ;% P3p2_P.HILInitialize_set_pwm_outputs_g
	  ...
	  ;% P3p2_P.HILInitialize_set_pwm_params__m
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P3p2_DW.ToFile_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 12;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P3p2_DW.ToFile1_PWORK.FilePtr
	  section.data(2).logicalSrcIdx = 13;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P3p2_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 14;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P3p2_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 15;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P3p2_DW.PitchScoperad_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 16;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P3p2_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 17;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P3p2_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P3p2_DW.TravelScoperad_PWORK.LoggedData
	  ...
	  ;% P3p2_DW.ToFile_IWORK.Count
	  section.data(1).logicalSrcIdx = 31;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P3p2_DW.ToFile1_IWORK.Count
	  section.data(2).logicalSrcIdx = 32;
	  section.data(2).dtTransOffset = 1;
  ...
  targMap.checksum0 = 2523257345;
  targMap.checksum1 = 2128336228;
  targMap.checksum2 = 1401728192;
  targMap.checksum3 = 621053527;
