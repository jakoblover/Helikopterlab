...
void P3p2_output(void)
{
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
    ...
    /* S-Function Block: P3p2/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_Gain2 = P3p2_DW.HILReadEncoderTimebase_Buffer[1];
        rtb_Gain1 = P3p2_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }

    /* Gain: '<S2>/Pitch: Count to rad' */
    P3p2_B.PitchCounttorad = P3p2_P.PitchCounttorad_Gain * rtb_Gain2;

    /* Gain: '<S2>/Deg to Rad   ' incorporates:
     *  Gain: '<S7>/Gain'
     */
    P3p2_B.DegtoRad = P3p2_P.Gain_Gain * P3p2_B.PitchCounttorad *
      P3p2_P.DegtoRad_Gain;
  }
   ...
   */
  P3p2_B.DegtoRad_o = (P3p2_P.PitchTransferFcn_C *
                       P3p2_X.PitchTransferFcn_CSTATE +
                       P3p2_P.PitchTransferFcn_D * P3p2_B.PitchCounttorad) *
    P3p2_P.Gain_Gain_c * P3p2_P.DegtoRad_Gain_m;
  if (rtmIsMajorTimeStep(P3p2_M)) {
    /* Gain: '<S2>/Elevation: Count to rad' */
    P3p2_B.ElevationCounttorad = P3p2_P.ElevationCounttorad_Gain * rtb_Gain1;
     ...
     *  Sum: '<S2>/Sum'
     */
    P3p2_B.DegtoRad_oh = (P3p2_P.Gain_Gain_i * P3p2_B.ElevationCounttorad +
                          P3p2_P.Constant_Value) * P3p2_P.DegtoRad_Gain_k;
  }
   ...
   */
  P3p2_B.DegtoRad_i = (P3p2_P.ElevationTransferFcn_C *
                       P3p2_X.ElevationTransferFcn_CSTATE +
                       P3p2_P.ElevationTransferFcn_D *
                       P3p2_B.ElevationCounttorad) * P3p2_P.Gain_Gain_o *
    P3p2_P.DegtoRad_Gain_d;
  if (rtmIsMajorTimeStep(P3p2_M)) {
     ...
     *  Gain: '<S9>/Gain'
     */
    P3p2_B.DegtoRad_l = P3p2_P.Gain_Gain_k * P3p2_B.TravelCounttorad *
      P3p2_P.DegtoRad_Gain_kg;
  }
   ...
   */
  P3p2_B.DegtoRad_j = (P3p2_P.TravelTransferFcn_C *
                       P3p2_X.TravelTransferFcn_CSTATE +
                       P3p2_P.TravelTransferFcn_D * P3p2_B.TravelCounttorad) *
    P3p2_P.Gain_Gain_b * P3p2_P.DegtoRad_Gain_f;
  if (rtmIsMajorTimeStep(P3p2_M)) {
    /* SignalConversion: '<Root>/TmpSignal ConversionAtTo FileInport1' */
    rtb_TmpSignalConversionAtToFile[0] = P3p2_B.DegtoRad;
    rtb_TmpSignalConversionAtToFile[1] = P3p2_B.DegtoRad_o;
    rtb_TmpSignalConversionAtToFile[2] = P3p2_B.DegtoRad_oh;
    rtb_TmpSignalConversionAtToFile[3] = P3p2_B.DegtoRad_i;
    rtb_TmpSignalConversionAtToFile[4] = P3p2_B.DegtoRad_l;
    rtb_TmpSignalConversionAtToFile[5] = P3p2_B.DegtoRad_j;
      ...
      if (!(++P3p2_DW.ToFile_IWORK.Decimation % 1) &&
        ...
        if (fp != (NULL)) {
          ...
          if (fwrite(u, sizeof(real_T), 7, fp) != 7) {
            rtmSetErrorStatus(P3p2_M, "Error writing to MAT-file var.mat");
            return;
          }
    ...
    if (rtb_Gain1 > P3p2_P.DeadZonex_End) {
      rtb_Gain1 -= P3p2_P.DeadZonex_End;
    } else if (rtb_Gain1 >= P3p2_P.DeadZonex_Start) {
      rtb_Gain1 = 0.0;
    } else {
      rtb_Gain1 -= P3p2_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S3>/Gain: x'
     */
    P3p2_B.Joystick_gain_x = P3p2_P.Gainx_Gain * rtb_Gain1 *
      P3p2_P.Joystick_gain_x;

    /* DeadZone: '<S3>/Dead Zone: y' */
    if (rtb_Gain2 > P3p2_P.DeadZoney_End) {
      rtb_Gain2 -= P3p2_P.DeadZoney_End;
    } else if (rtb_Gain2 >= P3p2_P.DeadZoney_Start) {
      rtb_Gain2 = 0.0;
    } else {
      rtb_Gain2 -= P3p2_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S3>/Gain: y'
     */
    P3p2_B.Joystick_gain_y = P3p2_P.Gainy_Gain * rtb_Gain2 *
      P3p2_P.Joystick_gain_y;

    /* SignalConversion: '<Root>/TmpSignal ConversionAtTo File1Inport1' */
    rtb_TmpSignalConversionAtProd_f[0] = P3p2_B.Joystick_gain_x;
    rtb_TmpSignalConversionAtProd_f[1] = P3p2_B.Joystick_gain_y;
      ...
      if (!(++P3p2_DW.ToFile1_IWORK.Decimation % 1) &&
        ...
        if (fp != (NULL)) {
          ...
          if (fwrite(u, sizeof(real_T), 3, fp) != 3) {
            rtmSetErrorStatus(P3p2_M, "Error writing to MAT-file joystick.mat");
            return;
          }
    ...
    /* Gain: '<Root>/Gain1' */
    rtb_Gain1 = P3p2_P.Gain1_Gain * P3p2_B.Joystick_gain_x;

    /* Gain: '<Root>/Gain2' */
    rtb_Gain2 = P3p2_P.Gain2_Gain * P3p2_B.Joystick_gain_y;

    /* SignalConversion: '<S4>/TmpSignal ConversionAtProduct2Inport2' */
    rtb_TmpSignalConversionAtProd_f[0] = rtb_Gain1;
    rtb_TmpSignalConversionAtProd_f[1] = rtb_Gain2;

    /* Product: '<S4>/Product2' incorporates:
     *  Constant: '<S4>/P Matrix'
     */
    P3p2_B.Product2[0] = 0.0;
    P3p2_B.Product2[0] += P3p2_P.P[0] * rtb_TmpSignalConversionAtProd_f[0];
    P3p2_B.Product2[0] += P3p2_P.P[2] * rtb_TmpSignalConversionAtProd_f[1];
    P3p2_B.Product2[1] = 0.0;
    P3p2_B.Product2[1] += P3p2_P.P[1] * rtb_TmpSignalConversionAtProd_f[0];
    P3p2_B.Product2[1] += P3p2_P.P[3] * rtb_TmpSignalConversionAtProd_f[1];
  }
   ...
   */
  for (i = 0; i < 2; i++) {
    rtb_Add_i[i] = P3p2_B.Product2[i] - ((P3p2_P.K[i + 2] * P3p2_B.DegtoRad_o +
      P3p2_P.K[i] * P3p2_B.DegtoRad) + P3p2_P.K[i + 4] * P3p2_B.DegtoRad_i);
  }
   ...
   *  Constant: '<Root>/V*_s'
   */
  rtb_Backgain = -P3p2_P.l_2 / P3p2_P.l_3 + rtb_Add_i[0];
  if (rtmIsMajorTimeStep(P3p2_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Add_i[1] + rtb_Backgain) * P3p2_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Backgain - rtb_Add_i[1]) * P3p2_P.Backgain_Gain;
...
void P3p2_initialize(void)
{
  ...
  /* S-Function Block: P3p2/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((P3p2_P.HILInitialize_set_analog_input_ && !is_switching) ||
        (P3p2_P.HILInitialize_set_analog_inpu_o && is_switching)) {
      {
        int_T i1;
    ...
    if ((P3p2_P.HILInitialize_set_analog_outp_e && !is_switching) ||
        (P3p2_P.HILInitialize_set_analog_outp_k && is_switching)) {
      {
        int_T i1;
    ...
    if (P3p2_P.HILInitialize_set_analog_outp_o) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &P3p2_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((P3p2_P.HILInitialize_set_encoder_param && !is_switching) ||
        (P3p2_P.HILInitialize_set_encoder_par_k && is_switching)) {
      {
        int_T i1;
    ...
    if ((P3p2_P.HILInitialize_set_encoder_count && !is_switching) ||
        (P3p2_P.HILInitialize_set_encoder_cou_g && is_switching)) {
      {
        int_T i1;
    ...
    if ((P3p2_P.HILInitialize_set_pwm_params_at && !is_switching) ||
        (P3p2_P.HILInitialize_set_pwm_params__m && is_switching)) {
    ...
    if ((P3p2_P.HILInitialize_set_pwm_outputs_a && !is_switching) ||
        (P3p2_P.HILInitialize_set_pwm_outputs_c && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &P3p2_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
  ...
  /* Start for ToFile: '<Root>/To File' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P3p2_M, "Error creating .mat file var.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,7,0,"var")) {
      rtmSetErrorStatus(P3p2_M, "Error writing mat file header to file var.mat");
      return;
    }
  ...
  /* Start for ToFile: '<Root>/To File1' */
  {
    ...
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P3p2_M, "Error creating .mat file joystick.mat");
      return;
    }
...
void P3p2_terminate(void)
{
  ...
  /* S-Function Block: P3p2/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    if ((P3p2_P.HILInitialize_set_analog_outp_l && !is_switching) ||
        (P3p2_P.HILInitialize_set_analog_outp_h && is_switching)) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &P3p2_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((P3p2_P.HILInitialize_set_pwm_outputs_g && !is_switching) ||
        (P3p2_P.HILInitialize_set_pwm_output_c4 && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &P3p2_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "var.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P3p2_M, "Error closing MAT-file var.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P3p2_M, "Error reopening MAT-file var.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 7, P3p2_DW.ToFile_IWORK.Count, "var")) {
        rtmSetErrorStatus(P3p2_M,
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "joystick.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P3p2_M, "Error closing MAT-file joystick.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P3p2_M, "Error reopening MAT-file joystick.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 3, P3p2_DW.ToFile1_IWORK.Count,
           "joystick_output")) {
        rtmSetErrorStatus(P3p2_M,
...
RT_MODEL_P3p2_T *P3p2(void)
{
  ...
  /* Initialize timing info */
  {
    ...
    P3p2_M->Timing.sampleTimes[1] = (0.01);
  ...
  P3p2_M->Timing.stepSize0 = 0.01;
  P3p2_M->Timing.stepSize1 = 0.01;

  /* External mode info */
  P3p2_M->Sizes.checksums[0] = (2523257345U);
  P3p2_M->Sizes.checksums[1] = (2128336228U);
  P3p2_M->Sizes.checksums[2] = (1401728192U);
  P3p2_M->Sizes.checksums[3] = (621053527U);
  ...
  P3p2_M->Timing.stepSize = (0.01);
  rtsiSetFixedStepSize(&P3p2_M->solverInfo, 0.01);
  rtsiSetSolverMode(&P3p2_M->solverInfo, SOLVER_MODE_SINGLETASKING);
...

  {
    ...
    P3p2_B.DegtoRad = 0.0;
    P3p2_B.DegtoRad_o = 0.0;
    P3p2_B.ElevationCounttorad = 0.0;
    P3p2_B.DegtoRad_oh = 0.0;
    P3p2_B.DegtoRad_i = 0.0;
    P3p2_B.TravelCounttorad = 0.0;
    P3p2_B.DegtoRad_l = 0.0;
    P3p2_B.DegtoRad_j = 0.0;
  ...
  P3p2_M->Sizes.numSampTimes = (2);    /* Number of sample times */
  P3p2_M->Sizes.numBlocks = (59);      /* Number of blocks */
  P3p2_M->Sizes.numBlockIO = (14);     /* Number of block outputs */
  P3p2_M->Sizes.numBlockPrms = (160);  /* Sum of parameter "widths" */
  return P3p2_M;
}
