  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P4p2_integral_P.A_LC
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p2_integral_P.B_obs
	  ...
	  section.data(20).dtTransOffset = 94;
	
	  ;% P4p2_integral_P.HILInitialize_set_other_outputs
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 95;
	
	  ;% P4p2_integral_P.HILInitialize_set_other_outpu_i
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 96;
	
	  ;% P4p2_integral_P.HILInitialize_set_other_outpu_k
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 97;
	
	  ;% P4p2_integral_P.HILInitialize_set_other_outpu_o
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_analog_inpu_o
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_analog_outp_d
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_analog_outp_k
	  section.data(9).logicalSrcIdx = 50;
	  section.data(9).dtTransOffset = 8;
	
	  ;% P4p2_integral_P.HILInitialize_set_analog_outp_h
	  section.data(10).logicalSrcIdx = 51;
	  section.data(10).dtTransOffset = 9;
	
	  ;% P4p2_integral_P.HILInitialize_set_analog_outp_l
	  section.data(11).logicalSrcIdx = 52;
	  section.data(11).dtTransOffset = 10;
	
	  ;% P4p2_integral_P.HILInitialize_set_analog_outp_o
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_clock_frequ_l
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_clock_param_a
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_digital_out_p
	  section.data(20).logicalSrcIdx = 61;
	  section.data(20).dtTransOffset = 19;
	
	  ;% P4p2_integral_P.HILInitialize_set_digital_out_g
	  section.data(21).logicalSrcIdx = 62;
	  section.data(21).dtTransOffset = 20;
	
	  ;% P4p2_integral_P.HILInitialize_set_digital_ou_gs
	  section.data(22).logicalSrcIdx = 63;
	  section.data(22).dtTransOffset = 21;
	
	  ;% P4p2_integral_P.HILInitialize_set_digital_ou_pm
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_encoder_cou_g
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_encoder_par_k
	  section.data(27).logicalSrcIdx = 68;
	  section.data(27).dtTransOffset = 26;
	
	  ;% P4p2_integral_P.HILInitialize_set_other_outp_kp
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_pwm_outputs_c
	  section.data(30).logicalSrcIdx = 71;
	  section.data(30).dtTransOffset = 29;
	
	  ;% P4p2_integral_P.HILInitialize_set_pwm_output_c4
	  ...
	  ;% P4p2_integral_P.HILInitialize_set_pwm_params__m
	  ...
	  ;% P4p2_integral_P.Constant3_Value
	  section.data(4).logicalSrcIdx = 80;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P4p2_integral_P.Constant1_Value
	  section.data(5).logicalSrcIdx = 81;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P4p2_integral_P.Constant2_Value
	  ...
	  ;% P4p2_integral_P.Gain_Gain_i
	  section.data(16).logicalSrcIdx = 92;
	  section.data(16).dtTransOffset = 15;
	
	  ;% P4p2_integral_P.Constant_Value
	  ...
	  ;% P4p2_integral_P.Gain_Gain_o
	  section.data(22).logicalSrcIdx = 98;
	  section.data(22).dtTransOffset = 21;
	
	  ;% P4p2_integral_P.DegtoRad_Gain_d
	  ...
	  ;% P4p2_integral_P.Gain_Gain_k
	  section.data(25).logicalSrcIdx = 101;
	  section.data(25).dtTransOffset = 24;
	
	  ;% P4p2_integral_P.DegtoRad_Gain_kg
	  ...
	  ;% P4p2_integral_P.Gain_Gain_b
	  section.data(30).logicalSrcIdx = 106;
	  section.data(30).dtTransOffset = 29;
	
	  ;% P4p2_integral_P.DegtoRad_Gain_f
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P4p2_integral_B.DegtoRad
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P4p2_integral_B.DegtoRad_o
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	  ...
	  ;% P4p2_integral_B.DegtoRad_oh
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P4p2_integral_B.DegtoRad_i
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 5;
	  ...
	  ;% P4p2_integral_B.DegtoRad_l
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 7;
	
	  ;% P4p2_integral_B.DegtoRad_j
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 8;
	  ...
	  ;% P4p2_integral_B.GOUP
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 10;
	
	  ;% P4p2_integral_B.Integrator
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 11;
	  ...
	  ;% P4p2_integral_B.Gamma_dot
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 23;
	
	  ;% P4p2_integral_B.Zeta_dot
	  section.data(19).logicalSrcIdx = 18;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p2_integral_DW.ToFile1_PWORK.FilePtr
	  section.data(2).logicalSrcIdx = 13;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P4p2_integral_DW.ToFile2_PWORK.FilePtr
	  section.data(3).logicalSrcIdx = 14;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P4p2_integral_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 15;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P4p2_integral_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 16;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P4p2_integral_DW.PitchScoperad_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 17;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P4p2_integral_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P4p2_integral_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 19;
	  section.data(8).dtTransOffset = 7;
	
	  ;% P4p2_integral_DW.TravelScoperad_PWORK.LoggedData
	  ...
	  ;% P4p2_integral_DW.ToFile1_IWORK.Count
	  section.data(2).logicalSrcIdx = 33;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P4p2_integral_DW.ToFile2_IWORK.Count
  ...
  targMap.checksum0 = 735986915;
  targMap.checksum1 = 2871507017;
  targMap.checksum2 = 3635297483;
  targMap.checksum3 = 2711951585;
