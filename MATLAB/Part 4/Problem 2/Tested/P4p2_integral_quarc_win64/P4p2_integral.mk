...
MODEL                = P4p2_integral
MODULES              = P4p2_integral_data.c P4p2_integral_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P4p2_integral.mk
...
MODELLIB                  = P4p2_integrallib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P4p2_integral_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\pamarton\Desktop\HELIKO~1\MATLAB\PART4~1\PROBLE~1\Tested
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P4p2_integral_quarc_win64
