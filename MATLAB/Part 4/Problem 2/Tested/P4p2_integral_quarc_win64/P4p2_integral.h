 ...
 */
#ifndef RTW_HEADER_P4p2_integral_h_
#define RTW_HEADER_P4p2_integral_h_
#include <stddef.h>
#include <string.h>
#ifndef P4p2_integral_COMMON_INCLUDES_
# define P4p2_integral_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P4p2_integral_COMMON_INCLUDES_ */

#include "P4p2_integral_types.h"
...
#define P4p2_integral_rtModel          RT_MODEL_P4p2_integral_T

/* Block signals (auto storage) */
typedef struct {
  real_T PitchCounttorad;              /* '<S2>/Pitch: Count to rad' */
  real_T DegtoRad;                     /* '<S2>/Deg to Rad   ' */
  real_T DegtoRad_o;                   /* '<S2>/Deg to Rad    ' */
  real_T ElevationCounttorad;          /* '<S2>/Elevation: Count to rad' */
  real_T DegtoRad_oh;                  /* '<S2>/Deg to Rad     ' */
  real_T DegtoRad_i;                   /* '<S2>/Deg to Rad      ' */
  real_T TravelCounttorad;             /* '<S2>/Travel: Count to rad' */
  real_T DegtoRad_l;                   /* '<S2>/Deg to Rad' */
  real_T DegtoRad_j;                   /* '<S2>/Deg to Rad  ' */
  real_T Joystick_gain_x;              /* '<S3>/Joystick_gain_x' */
  real_T GOUP;                         /* '<S12>/GO UP' */
  real_T Integrator[6];                /* '<S5>/Integrator' */
  real_T Gain;                         /* '<Root>/Gain' */
  real_T Gain3;                        /* '<Root>/Gain3' */
  real_T Product2[2];                  /* '<S4>/Product2' */
  real_T FrontmotorSaturation;         /* '<S2>/Front motor: Saturation' */
  real_T BackmotorSaturation;          /* '<S2>/Back motor: Saturation' */
  real_T Gamma_dot;                    /* '<S4>/Gamma_dot' */
  real_T Zeta_dot;                     /* '<S4>/Zeta_dot' */
  real_T Ly[6];                        /* '<S5>/L * y' */
  real_T Sum[6];                       /* '<S5>/Sum' */
} B_P4p2_integral_T;
...
typedef struct {
  ...
  real_T Gamma_CSTATE;                 /* '<S4>/Gamma' */
  real_T Zeta_CSTATE;                  /* '<S4>/Zeta' */
} X_P4p2_integral_T;
...
typedef struct {
  ...
  boolean_T Gamma_CSTATE;              /* '<S4>/Gamma' */
  boolean_T Zeta_CSTATE;               /* '<S4>/Zeta' */
} XDis_P4p2_integral_T;
...
#define rtB                            P4p2_integral_B
#define BlockIO                        B_P4p2_integral_T
#define rtX                            P4p2_integral_X
#define ContinuousStates               X_P4p2_integral_T
#define rtXdot                         P4p2_integral_XDot
#define StateDerivatives               XDot_P4p2_integral_T
#define tXdis                          P4p2_integral_XDis
#define StateDisabled                  XDis_P4p2_integral_T
#define rtP                            P4p2_integral_P
#define Parameters                     P_P4p2_integral_T
#define rtDWork                        P4p2_integral_DW
#define D_Work                         DW_P4p2_integral_T

/* Parameters (auto storage) */
struct P_P4p2_integral_T_ {
  real_T A_LC[36];                     /* Variable: A_LC
                                        * Referenced by: '<S5>/Multiply A-LC with X_hat'
                                        */
  real_T B_obs[12];                    /* Variable: B_obs
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        */
  real_T K_PI[10];                     /* Variable: K_PI
                                        * Referenced by: '<S4>/Constant1'
                                        */
  real_T L[18];                        /* Variable: L
                                        * Referenced by: '<S5>/L * y'
                                        */
  real_T P_PI[4];                      /* Variable: P_PI
  ...
  boolean_T HILInitialize_set_digital_out_g;/* Mask Parameter: HILInitialize_set_digital_out_g
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_digital_ou_gs;/* Mask Parameter: HILInitialize_set_digital_ou_gs
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_encoder_count;/* Mask Parameter: HILInitialize_set_encoder_count
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_encoder_cou_g;/* Mask Parameter: HILInitialize_set_encoder_cou_g
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_encoder_par_k;/* Mask Parameter: HILInitialize_set_encoder_par_k
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_other_outp_kp;/* Mask Parameter: HILInitialize_set_other_outp_kp
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_pwm_outputs_c;/* Mask Parameter: HILInitialize_set_pwm_outputs_c
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_pwm_output_c4;/* Mask Parameter: HILInitialize_set_pwm_output_c4
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_pwm_params__m;/* Mask Parameter: HILInitialize_set_pwm_params__m
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T DeadZoney_Start;              /* Expression: -0.15
                                        * Referenced by: '<S3>/Dead Zone: y'
                                        */
  real_T DeadZoney_End;                /* Expression: 0.15
                                        * Referenced by: '<S3>/Dead Zone: y'
                                        */
  ...
  real_T Gain_Gain_c;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T DegtoRad_Gain_m;              /* Expression: pi/180
                                        * Referenced by: '<S2>/Deg to Rad    '
                                        */
  ...
  real_T Gain_Gain_o;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T DegtoRad_Gain_d;              /* Expression: pi/180
                                        * Referenced by: '<S2>/Deg to Rad      '
                                        */
  ...
  real_T Gain_Gain_k;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T DegtoRad_Gain_kg;             /* Expression: pi/180
                                        * Referenced by: '<S2>/Deg to Rad'
                                        */
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_o4;                 /* Expression: -1
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T Gain3_Gain;                   /* Expression: -1
                                        * Referenced by: '<Root>/Gain3'
                                        */
  real_T Gamma_IC;                     /* Expression: 0
...
struct tag_RTM_P4p2_integral_T {
  const char_T *path;
...
extern P_P4p2_integral_T P4p2_integral_P;

/* Block signals (auto storage) */
extern B_P4p2_integral_T P4p2_integral_B;

/* Continuous states (auto storage) */
extern X_P4p2_integral_T P4p2_integral_X;

/* Block states (auto storage) */
extern DW_P4p2_integral_T P4p2_integral_DW;

/* Model entry point functions */
extern void P4p2_integral_initialize(void);
extern void P4p2_integral_output(void);
extern void P4p2_integral_update(void);
extern void P4p2_integral_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P4p2_integral_T *const P4p2_integral_M;
 ...
 *
 * '<Root>' : 'P4p2_integral'
 * '<S1>'   : 'P4p2_integral/Conversion'
 * '<S2>'   : 'P4p2_integral/Heli 3D'
 * '<S3>'   : 'P4p2_integral/Joystick1'
 * '<S4>'   : 'P4p2_integral/LQR controller1'
 * '<S5>'   : 'P4p2_integral/Linear Observer'
 * '<S6>'   : 'P4p2_integral/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'P4p2_integral/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'P4p2_integral/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'P4p2_integral/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'P4p2_integral/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'P4p2_integral/Heli 3D/Travel rate  rad to deg'
 * '<S12>'  : 'P4p2_integral/Joystick1/Controll Buttons'
 */
#endif                                 /* RTW_HEADER_P4p2_integral_h_ */
