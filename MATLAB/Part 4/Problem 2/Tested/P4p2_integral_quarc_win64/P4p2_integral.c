 ...
 * C source code generated on : Sat Oct 21 00:25:37 2017
 *
...
void P4p2_integral_output(void)
{
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    /* S-Function Block: P4p2_integral/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_DeadZonex = P4p2_integral_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
     ...
     *  Gain: '<S8>/Gain'
     */
    P4p2_integral_B.DegtoRad = P4p2_integral_P.Gain_Gain *
      P4p2_integral_B.PitchCounttorad * P4p2_integral_P.DegtoRad_Gain;
  }
   ...
   */
  P4p2_integral_B.DegtoRad_o = (P4p2_integral_P.PitchTransferFcn_C *
    P4p2_integral_X.PitchTransferFcn_CSTATE + P4p2_integral_P.PitchTransferFcn_D
    * P4p2_integral_B.PitchCounttorad) * P4p2_integral_P.Gain_Gain_c *
    P4p2_integral_P.DegtoRad_Gain_m;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    /* Gain: '<S2>/Elevation: Count to rad' */
    P4p2_integral_B.ElevationCounttorad =
      P4p2_integral_P.ElevationCounttorad_Gain * rtb_DeadZonex;
     ...
     *  Sum: '<S2>/Sum'
     */
    P4p2_integral_B.DegtoRad_oh = (P4p2_integral_P.Gain_Gain_i *
      P4p2_integral_B.ElevationCounttorad + P4p2_integral_P.Constant_Value) *
      P4p2_integral_P.DegtoRad_Gain_k;
  }
   ...
   */
  P4p2_integral_B.DegtoRad_i = (P4p2_integral_P.ElevationTransferFcn_C *
    P4p2_integral_X.ElevationTransferFcn_CSTATE +
    P4p2_integral_P.ElevationTransferFcn_D * P4p2_integral_B.ElevationCounttorad)
    * P4p2_integral_P.Gain_Gain_o * P4p2_integral_P.DegtoRad_Gain_d;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
     ...
     *  Gain: '<S10>/Gain'
     */
    P4p2_integral_B.DegtoRad_l = P4p2_integral_P.Gain_Gain_k *
      P4p2_integral_B.TravelCounttorad * P4p2_integral_P.DegtoRad_Gain_kg;
  }
   ...
   */
  P4p2_integral_B.DegtoRad_j = (P4p2_integral_P.TravelTransferFcn_C *
    P4p2_integral_X.TravelTransferFcn_CSTATE +
    P4p2_integral_P.TravelTransferFcn_D * P4p2_integral_B.TravelCounttorad) *
    P4p2_integral_P.Gain_Gain_b * P4p2_integral_P.DegtoRad_Gain_f;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    /* SignalConversion: '<Root>/TmpSignal ConversionAtTo FileInport1' */
    rtb_TmpSignalConversionAtToFile[0] = P4p2_integral_B.DegtoRad;
    rtb_TmpSignalConversionAtToFile[1] = P4p2_integral_B.DegtoRad_o;
    rtb_TmpSignalConversionAtToFile[2] = P4p2_integral_B.DegtoRad_oh;
    rtb_TmpSignalConversionAtToFile[3] = P4p2_integral_B.DegtoRad_i;
    rtb_TmpSignalConversionAtToFile[4] = P4p2_integral_B.DegtoRad_l;
    rtb_TmpSignalConversionAtToFile[5] = P4p2_integral_B.DegtoRad_j;

    /* ToFile: '<Root>/To File' */
    {
      if (!(++P4p2_integral_DW.ToFile_IWORK.Decimation % 1) &&
          (P4p2_integral_DW.ToFile_IWORK.Count*7)+1 < 100000000 ) {
        FILE *fp = (FILE *) P4p2_integral_DW.ToFile_PWORK.FilePtr;
        if (fp != (NULL)) {
          real_T u[7];
          P4p2_integral_DW.ToFile_IWORK.Decimation = 0;
          u[0] = P4p2_integral_M->Timing.t[1];
          ...
          if (fwrite(u, sizeof(real_T), 7, fp) != 7) {
            rtmSetErrorStatus(P4p2_integral_M,
                              "Error writing to MAT-file var_integral.mat");
            return;
          }

          if (((++P4p2_integral_DW.ToFile_IWORK.Count)*7)+1 >= 100000000) {
            (void)fprintf(stdout,
                          "*** The ToFile block will stop logging data before\n"
                          "    the simulation has ended, because it has reached\n"
                          "    the maximum number of elements (100000000)\n"
                          "    allowed in MAT-file var_integral.mat.\n");
          }
        }
      }
    }
    ...
    /* S-Function Block: P4p2_integral/Joystick1/Game Controller (game_controller_block) */
    {
    ...
    if (rtb_DeadZonex > P4p2_integral_P.DeadZonex_End) {
      rtb_DeadZonex -= P4p2_integral_P.DeadZonex_End;
    } else if (rtb_DeadZonex >= P4p2_integral_P.DeadZonex_Start) {
      rtb_DeadZonex = 0.0;
    } else {
      rtb_DeadZonex -= P4p2_integral_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S3>/Gain: x'
     */
    P4p2_integral_B.Joystick_gain_x = P4p2_integral_P.Gainx_Gain * rtb_DeadZonex
    ...
    rtb_Frontgain = rtb_TmpSignalConversionAtProd_f[0] -
      P4p2_integral_P.Constant4_Value;
    ...
    if ((rtb_GameController_o2[0] && rtb_GameController_o2[4]) ||
      ...
      P4p2_integral_B.GOUP = rtb_Frontgain * P4p2_integral_P.Constant2_Value;
    } else {
      if ((rtb_GameController_o2[0] && rtb_GameController_o2[2]) ||
         ...
         *  Product: '<S12>/Product'
         */
        rtb_Frontgain *= P4p2_integral_P.Constant1_Value;
      } else if (rtb_GameController_o2[0]) {
        /* Switch: '<S12>/DON'T MOVE!' incorporates:
         *  Constant: '<S12>/Constant3'
         *  Switch: '<S12>/GO DOWN'
         */
        rtb_Frontgain = P4p2_integral_P.Constant3_Value;
      } else {
        if (rtb_GameController_o5 > P4p2_integral_P.DeadZoney_End) {
          /* DeadZone: '<S3>/Dead Zone: y' incorporates:
           *  Switch: '<S12>/DON'T MOVE!'
           *  Switch: '<S12>/GO DOWN'
           */
          rtb_Frontgain = rtb_GameController_o5 - P4p2_integral_P.DeadZoney_End;
        } else if (rtb_GameController_o5 >= P4p2_integral_P.DeadZoney_Start) {
          /* DeadZone: '<S3>/Dead Zone: y' incorporates:
           *  Switch: '<S12>/DON'T MOVE!'
           *  Switch: '<S12>/GO DOWN'
           */
           ...
           *  Switch: '<S12>/GO DOWN'
           */
          rtb_Frontgain = rtb_GameController_o5 -
         ...
         *  Switch: '<S12>/GO DOWN'
         */
        rtb_Frontgain = P4p2_integral_P.Gainy_Gain * rtb_Frontgain *
          P4p2_integral_P.Joystick_gain_y;
      }

      P4p2_integral_B.GOUP = rtb_Frontgain;
    }

    /* End of Switch: '<S12>/GO UP' */

    /* SignalConversion: '<Root>/TmpSignal ConversionAtTo File1Inport1' */
    rtb_TmpSignalConversionAtProd_f[0] = P4p2_integral_B.Joystick_gain_x;
    rtb_TmpSignalConversionAtProd_f[1] = P4p2_integral_B.GOUP;

    /* ToFile: '<Root>/To File1' */
    {
      if (!(++P4p2_integral_DW.ToFile1_IWORK.Decimation % 1) &&
          (P4p2_integral_DW.ToFile1_IWORK.Count*3)+1 < 100000000 ) {
        FILE *fp = (FILE *) P4p2_integral_DW.ToFile1_PWORK.FilePtr;
        if (fp != (NULL)) {
          real_T u[3];
          P4p2_integral_DW.ToFile1_IWORK.Decimation = 0;
          u[0] = P4p2_integral_M->Timing.t[1];
          u[1] = rtb_TmpSignalConversionAtProd_f[0];
          u[2] = rtb_TmpSignalConversionAtProd_f[1];
          if (fwrite(u, sizeof(real_T), 3, fp) != 3) {
            rtmSetErrorStatus(P4p2_integral_M,
                              "Error writing to MAT-file joystick_integral.mat");
            return;
          }

          if (((++P4p2_integral_DW.ToFile1_IWORK.Count)*3)+1 >= 100000000) {
            (void)fprintf(stdout,
                          "*** The ToFile block will stop logging data before\n"
                          "    the simulation has ended, because it has reached\n"
                          "    the maximum number of elements (100000000)\n"
                          "    allowed in MAT-file joystick_integral.mat.\n");
          }
        }
      }
    }
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    rtb_TmpSignalConversionAtLyInpo[0] = P4p2_integral_B.Integrator[0];
    rtb_TmpSignalConversionAtLyInpo[1] = P4p2_integral_B.Integrator[1];
    rtb_TmpSignalConversionAtLyInpo[2] = P4p2_integral_B.Integrator[3];

    /* ToFile: '<Root>/To File2' */
    {
      if (!(++P4p2_integral_DW.ToFile2_IWORK.Decimation % 1) &&
          (P4p2_integral_DW.ToFile2_IWORK.Count*4)+1 < 100000000 ) {
        FILE *fp = (FILE *) P4p2_integral_DW.ToFile2_PWORK.FilePtr;
        if (fp != (NULL)) {
          real_T u[4];
          P4p2_integral_DW.ToFile2_IWORK.Decimation = 0;
          u[0] = P4p2_integral_M->Timing.t[1];
          ...
          if (fwrite(u, sizeof(real_T), 4, fp) != 4) {
            rtmSetErrorStatus(P4p2_integral_M,
                              "Error writing to MAT-file var_estimated_integral.mat");
            return;
          }

          if (((++P4p2_integral_DW.ToFile2_IWORK.Count)*4)+1 >= 100000000) {
            (void)fprintf(stdout,
                          "*** The ToFile block will stop logging data before\n"
                          "    the simulation has ended, because it has reached\n"
                          "    the maximum number of elements (100000000)\n"
                          "    allowed in MAT-file var_estimated_integral.mat.\n");
          }
        }
      }
    }
    ...
    /* Gain: '<Root>/Gain' */
    P4p2_integral_B.Gain = P4p2_integral_P.Gain_Gain_o4 *
      P4p2_integral_B.Joystick_gain_x;

    /* Gain: '<Root>/Gain3' */
    P4p2_integral_B.Gain3 = P4p2_integral_P.Gain3_Gain * P4p2_integral_B.GOUP;

    /* SignalConversion: '<S4>/TmpSignal ConversionAtProduct2Inport2' */
    rtb_TmpSignalConversionAtProd_f[0] = P4p2_integral_B.Gain;
    rtb_TmpSignalConversionAtProd_f[1] = P4p2_integral_B.Gain3;

    /* Product: '<S4>/Product2' incorporates:
     *  Constant: '<S4>/Constant2'
     */
    P4p2_integral_B.Product2[0] = 0.0;
    P4p2_integral_B.Product2[0] += P4p2_integral_P.P_PI[0] *
      rtb_TmpSignalConversionAtProd_f[0];
    P4p2_integral_B.Product2[0] += P4p2_integral_P.P_PI[2] *
      rtb_TmpSignalConversionAtProd_f[1];
    P4p2_integral_B.Product2[1] = 0.0;
    P4p2_integral_B.Product2[1] += P4p2_integral_P.P_PI[1] *
      rtb_TmpSignalConversionAtProd_f[0];
    P4p2_integral_B.Product2[1] += P4p2_integral_P.P_PI[3] *
      rtb_TmpSignalConversionAtProd_f[1];
  }
   ...
   *  Product: '<S4>/Product1'
   */
  tmp[0] = P4p2_integral_B.Integrator[0];
  tmp[1] = P4p2_integral_B.Integrator[1];
  tmp[2] = P4p2_integral_B.Integrator[3];
  tmp[3] = P4p2_integral_X.Gamma_CSTATE;
  tmp[4] = P4p2_integral_X.Zeta_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    rtb_Frontgain = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Frontgain += P4p2_integral_P.K_PI[(i_0 << 1) + i] * tmp[i_0];
    }

    rtb_Add_m[i] = P4p2_integral_B.Product2[i] - rtb_Frontgain;
  }
   ...
   *  Constant: '<Root>/V*_s'
   */
  rtb_Frontgain = -P4p2_integral_P.l_2 / P4p2_integral_P.l_3 + rtb_Add_m[0];
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Add_m[1] + rtb_Frontgain) * P4p2_integral_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Frontgain - rtb_Add_m[1]) * P4p2_integral_P.Backgain_Gain;
  ...
  /* Sum: '<S4>/Gamma_dot' */
  P4p2_integral_B.Gamma_dot = P4p2_integral_B.Integrator[0] -
    P4p2_integral_B.Gain;

  /* Sum: '<S4>/Zeta_dot' */
  P4p2_integral_B.Zeta_dot = P4p2_integral_B.Integrator[3] -
    P4p2_integral_B.Gain3;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    /* SignalConversion: '<S5>/TmpSignal ConversionAtL * yInport1' */
    rtb_TmpSignalConversionAtLyInpo[0] = P4p2_integral_B.DegtoRad;
    rtb_TmpSignalConversionAtLyInpo[1] = P4p2_integral_B.DegtoRad_oh;
    rtb_TmpSignalConversionAtLyInpo[2] = P4p2_integral_B.DegtoRad_l;

    /* Gain: '<S5>/L * y' */
    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Ly[i] = 0.0;
      P4p2_integral_B.Ly[i] += P4p2_integral_P.L[i] *
        rtb_TmpSignalConversionAtLyInpo[0];
      P4p2_integral_B.Ly[i] += P4p2_integral_P.L[i + 6] *
        rtb_TmpSignalConversionAtLyInpo[1];
      P4p2_integral_B.Ly[i] += P4p2_integral_P.L[i + 12] *
        rtb_TmpSignalConversionAtLyInpo[2];
    }
  ...
  for (i = 0; i < 6; i++) {
    rtb_Frontgain = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Frontgain += P4p2_integral_P.A_LC[6 * i_0 + i] *
        P4p2_integral_B.Integrator[i_0];
    }

    tmp_0[i] = rtb_Frontgain + P4p2_integral_B.Ly[i];
  }

  for (i = 0; i < 6; i++) {
    P4p2_integral_B.Sum[i] = tmp_0[i] + (P4p2_integral_P.B_obs[i + 6] *
      rtb_Add_m[1] + P4p2_integral_P.B_obs[i] * rtb_Add_m[0]);
  }
...
void P4p2_integral_update(void)
{
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
...
void P4p2_integral_derivatives(void)
{
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator_CSTATE[i] = P4p2_integral_B.Sum[i];
  }

  /* End of Derivatives for Integrator: '<S5>/Integrator' */

  /* Derivatives for Integrator: '<S4>/Gamma' */
  _rtXdot->Gamma_CSTATE = P4p2_integral_B.Gamma_dot;

  /* Derivatives for Integrator: '<S4>/Zeta' */
  _rtXdot->Zeta_CSTATE = P4p2_integral_B.Zeta_dot;
}
...
void P4p2_integral_initialize(void)
{
  ...
  /* S-Function Block: P4p2_integral/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((P4p2_integral_P.HILInitialize_set_analog_input_ && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_analog_inpu_o && is_switching)) {
      {
        int_T i1;
    ...
    if ((P4p2_integral_P.HILInitialize_set_analog_output && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_analog_outp_d && is_switching)) {
      {
        int_T i1;
    ...
    if ((P4p2_integral_P.HILInitialize_set_analog_outp_e && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_analog_outp_k && is_switching)) {
      {
        int_T i1;
    ...
    if (P4p2_integral_P.HILInitialize_set_analog_outp_o) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &P4p2_integral_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((P4p2_integral_P.HILInitialize_set_encoder_param && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_encoder_par_k && is_switching)) {
      {
        int_T i1;
    ...
    if ((P4p2_integral_P.HILInitialize_set_encoder_count && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_encoder_cou_g && is_switching)) {
      {
        int_T i1;
    ...
    if ((P4p2_integral_P.HILInitialize_set_pwm_params_at && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_pwm_params__m && is_switching)) {
    ...
    if ((P4p2_integral_P.HILInitialize_set_pwm_outputs_a && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_pwm_outputs_c && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &P4p2_integral_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
  ...
  {
    char fileName[509] = "var_integral.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error creating .mat file var_integral.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,7,0,"var_integral")) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error writing mat file header to file var_integral.mat");
      return;
    }

    P4p2_integral_DW.ToFile_IWORK.Count = 0;
    P4p2_integral_DW.ToFile_IWORK.Decimation = -1;
    P4p2_integral_DW.ToFile_PWORK.FilePtr = fp;
  }
  ...
  {
    char fileName[509] = "joystick_integral.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error creating .mat file joystick_integral.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,3,0,"joystick_output_integral")) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error writing mat file header to file joystick_integral.mat");
      return;
    }

    P4p2_integral_DW.ToFile1_IWORK.Count = 0;
    P4p2_integral_DW.ToFile1_IWORK.Decimation = -1;
    P4p2_integral_DW.ToFile1_PWORK.FilePtr = fp;
  }

  /* Start for ToFile: '<Root>/To File2' */
  {
    char fileName[509] = "var_estimated_integral.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error creating .mat file var_estimated_integral.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,4,0,"var_estimated_integral")) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error writing mat file header to file var_estimated_integral.mat");
      return;
    }

    P4p2_integral_DW.ToFile2_IWORK.Count = 0;
    P4p2_integral_DW.ToFile2_IWORK.Decimation = -1;
    P4p2_integral_DW.ToFile2_PWORK.FilePtr = fp;
  }

  {
    ...
    P4p2_integral_X.Gamma_CSTATE = P4p2_integral_P.Gamma_IC;

    /* InitializeConditions for Integrator: '<S4>/Zeta' */
    P4p2_integral_X.Zeta_CSTATE = P4p2_integral_P.Zeta_IC;
  }
}
...
void P4p2_integral_terminate(void)
{
  ...
  /* S-Function Block: P4p2_integral/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    if ((P4p2_integral_P.HILInitialize_set_analog_outp_l && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_analog_outp_h && is_switching)) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &P4p2_integral_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((P4p2_integral_P.HILInitialize_set_pwm_outputs_g && !is_switching) ||
        (P4p2_integral_P.HILInitialize_set_pwm_output_c4 && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &P4p2_integral_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error closing MAT-file var_integral.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error reopening MAT-file var_integral.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 7, P4p2_integral_DW.ToFile_IWORK.Count,
           "var_integral")) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error writing header for var_integral to MAT-file var_integral.mat");
      }
      ...
      P4p2_integral_DW.ToFile_PWORK.FilePtr = (NULL);
    }
  }
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error closing MAT-file joystick_integral.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error reopening MAT-file joystick_integral.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 3, P4p2_integral_DW.ToFile1_IWORK.Count,
           "joystick_output_integral")) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error writing header for joystick_output_integral to MAT-file joystick_integral.mat");
      }
      ...
      P4p2_integral_DW.ToFile1_PWORK.FilePtr = (NULL);
    }
  }
  ...
  /* Terminate for ToFile: '<Root>/To File2' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error closing MAT-file var_estimated_integral.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error reopening MAT-file var_estimated_integral.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 4, P4p2_integral_DW.ToFile2_IWORK.Count,
           "var_estimated_integral")) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error writing header for var_estimated_integral to MAT-file var_estimated_integral.mat");
      }
      ...
      P4p2_integral_DW.ToFile2_PWORK.FilePtr = (NULL);
    }
  }
}
...
{
  P4p2_integral_output();
  UNUSED_PARAMETER(tid);
}

void MdlUpdate(int_T tid)
{
  P4p2_integral_update();
  UNUSED_PARAMETER(tid);
}
...
RT_MODEL_P4p2_integral_T *P4p2_integral(void)
{
  ...
  /* Initialize timing info */
  {
    ...
    P4p2_integral_M->Timing.sampleTimes[1] = (0.01);
  ...
  P4p2_integral_M->Timing.stepSize0 = 0.01;
  P4p2_integral_M->Timing.stepSize1 = 0.01;

  /* External mode info */
  P4p2_integral_M->Sizes.checksums[0] = (735986915U);
  P4p2_integral_M->Sizes.checksums[1] = (2871507017U);
  P4p2_integral_M->Sizes.checksums[2] = (3635297483U);
  P4p2_integral_M->Sizes.checksums[3] = (2711951585U);
  ...
  P4p2_integral_M->Timing.stepSize = (0.01);
  rtsiSetFixedStepSize(&P4p2_integral_M->solverInfo, 0.01);
  rtsiSetSolverMode(&P4p2_integral_M->solverInfo, SOLVER_MODE_SINGLETASKING);
...

  {
    ...
    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Sum[i] = 0.0;
    }

    P4p2_integral_B.PitchCounttorad = 0.0;
    P4p2_integral_B.DegtoRad = 0.0;
    P4p2_integral_B.DegtoRad_o = 0.0;
    P4p2_integral_B.ElevationCounttorad = 0.0;
    P4p2_integral_B.DegtoRad_oh = 0.0;
    P4p2_integral_B.DegtoRad_i = 0.0;
    P4p2_integral_B.TravelCounttorad = 0.0;
    P4p2_integral_B.DegtoRad_l = 0.0;
    P4p2_integral_B.DegtoRad_j = 0.0;
    P4p2_integral_B.Joystick_gain_x = 0.0;
    P4p2_integral_B.GOUP = 0.0;
    P4p2_integral_B.Gain = 0.0;
    P4p2_integral_B.Gain3 = 0.0;
    P4p2_integral_B.Product2[0] = 0.0;
    P4p2_integral_B.Product2[1] = 0.0;
    P4p2_integral_B.FrontmotorSaturation = 0.0;
    P4p2_integral_B.BackmotorSaturation = 0.0;
    P4p2_integral_B.Gamma_dot = 0.0;
    P4p2_integral_B.Zeta_dot = 0.0;
  }
  ...
  P4p2_integral_M->Sizes.numSampTimes = (2);/* Number of sample times */
  P4p2_integral_M->Sizes.numBlocks = (91);/* Number of blocks */
  P4p2_integral_M->Sizes.numBlockIO = (21);/* Number of block outputs */
  P4p2_integral_M->Sizes.numBlockPrms = (237);/* Sum of parameter "widths" */
