...
struct P_P4p2_T_ {
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        */
  real_T K_P[6];                       /* Variable: K_P
                                        * Referenced by: '<S4>/Constant1'
                                        */
  real_T L[18];                        /* Variable: L
                                        * Referenced by: '<S5>/L * y'
                                        */
  real_T P_P[4];                       /* Variable: P_P
...
extern void P4p2_output(void);
extern void P4p2_update(void);
 ...
 * '<S2>'   : 'P4p2/Heli 3D'
 * '<S3>'   : 'P4p2/Joystick1'
 * '<S4>'   : 'P4p2/LQR controller1'
 * '<S5>'   : 'P4p2/Linear Observer'
 * '<S6>'   : 'P4p2/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'P4p2/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'P4p2/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'P4p2/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'P4p2/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'P4p2/Heli 3D/Travel rate  rad to deg'
 * '<S12>'  : 'P4p2/Joystick1/Controll Buttons'
 */
