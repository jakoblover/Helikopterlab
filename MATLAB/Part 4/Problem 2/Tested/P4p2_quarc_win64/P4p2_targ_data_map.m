  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(10).dtTransOffset = 80;
	  ...
	  section.data(18).dtTransOffset = 88;
	
	  ;% P4p2_P.HILInitialize_pwm_leading_deadb
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 89;
	
	  ;% P4p2_P.HILInitialize_pwm_trailing_dead
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 90;
	
	  ;% P4p2_P.HILInitialize_set_other_outputs
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 91;
	
	  ;% P4p2_P.HILInitialize_set_other_outpu_i
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 92;
	
	  ;% P4p2_P.HILInitialize_set_other_outpu_k
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 93;
	
	  ;% P4p2_P.HILInitialize_set_other_outpu_o
	  ...
	  ;% P4p2_P.HILInitialize_set_analog_inpu_o
	  ...
	  ;% P4p2_P.HILInitialize_set_analog_outp_d
	  ...
	  ;% P4p2_P.HILInitialize_set_analog_outp_k
	  ...
	  ;% P4p2_P.HILInitialize_set_analog_outp_o
	  ...
	  ;% P4p2_P.HILInitialize_set_clock_frequ_l
	  ...
	  ;% P4p2_P.HILInitialize_set_clock_param_a
	  ...
	  ;% P4p2_P.HILInitialize_set_digital_out_p
	  section.data(20).logicalSrcIdx = 61;
	  section.data(20).dtTransOffset = 19;
	
	  ;% P4p2_P.HILInitialize_set_digital_out_g
	  section.data(21).logicalSrcIdx = 62;
	  section.data(21).dtTransOffset = 20;
	
	  ;% P4p2_P.HILInitialize_set_digital_ou_gs
	  section.data(22).logicalSrcIdx = 63;
	  section.data(22).dtTransOffset = 21;
	
	  ;% P4p2_P.HILInitialize_set_digital_ou_pm
	  ...
	  ;% P4p2_P.HILInitialize_set_encoder_cou_g
	  ...
	  ;% P4p2_P.HILInitialize_set_encoder_par_k
	  section.data(27).logicalSrcIdx = 68;
	  section.data(27).dtTransOffset = 26;
	
	  ;% P4p2_P.HILInitialize_set_other_outp_kp
	  ...
	  ;% P4p2_P.HILInitialize_set_pwm_output_c4
	  ...
	  ;% P4p2_P.HILInitialize_set_pwm_params__m
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p2_DW.ToFile_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 12;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p2_DW.ToFile1_PWORK.FilePtr
	  section.data(2).logicalSrcIdx = 13;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P4p2_DW.ToFile2_PWORK.FilePtr
	  section.data(3).logicalSrcIdx = 14;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P4p2_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 15;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P4p2_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 16;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P4p2_DW.PitchScoperad_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 17;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P4p2_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P4p2_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 19;
	  section.data(8).dtTransOffset = 7;
	
	  ;% P4p2_DW.TravelScoperad_PWORK.LoggedData
	  ...
	  ;% P4p2_DW.ToFile_IWORK.Count
	  section.data(1).logicalSrcIdx = 32;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p2_DW.ToFile1_IWORK.Count
	  section.data(2).logicalSrcIdx = 33;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P4p2_DW.ToFile2_IWORK.Count
  ...
  targMap.checksum0 = 1723809449;
  targMap.checksum1 = 1559195230;
  targMap.checksum2 = 2633503710;
  targMap.checksum3 = 3251551099;
