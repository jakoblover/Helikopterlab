...
MODEL                = P4p2
MODULES              = P4p2_data.c P4p2_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P4p2.mk
...
MODELLIB                  = P4p2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P4p2_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P4p2_quarc_win64
