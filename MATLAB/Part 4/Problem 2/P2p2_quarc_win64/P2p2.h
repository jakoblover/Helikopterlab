 ...
 * C source code generated on : Fri Oct 20 19:48:58 2017
 *
 ...
 */
#ifndef RTW_HEADER_P2p2_h_
#define RTW_HEADER_P2p2_h_
#include <stddef.h>
#include <string.h>
#ifndef P2p2_COMMON_INCLUDES_
# define P2p2_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P2p2_COMMON_INCLUDES_ */

#include "P2p2_types.h"
...
#define P2p2_rtModel                   RT_MODEL_P2p2_T

/* Block signals (auto storage) */
typedef struct {
  real_T PitchCounttorad;              /* '<S3>/Pitch: Count to rad' */
  real_T DegtoRad;                     /* '<S3>/Deg to Rad   ' */
  real_T DegtoRad_o;                   /* '<S3>/Deg to Rad    ' */
  real_T ElevationCounttorad;          /* '<S3>/Elevation: Count to rad' */
  real_T DegtoRad_oh;                  /* '<S3>/Deg to Rad     ' */
  real_T DegtoRad_i;                   /* '<S3>/Deg to Rad      ' */
  real_T TravelCounttorad;             /* '<S3>/Travel: Count to rad' */
  real_T DegtoRad_l;                   /* '<S3>/Deg to Rad' */
  real_T DegtoRad_j;                   /* '<S3>/Deg to Rad  ' */
...
#define rtB                            P2p2_B
#define BlockIO                        B_P2p2_T
#define rtX                            P2p2_X
#define ContinuousStates               X_P2p2_T
#define rtXdot                         P2p2_XDot
#define StateDerivatives               XDot_P2p2_T
#define tXdis                          P2p2_XDis
#define StateDisabled                  XDis_P2p2_T
#define rtP                            P2p2_P
#define Parameters                     P_P2p2_T
#define rtDWork                        P2p2_DW
#define D_Work                         DW_P2p2_T
...
extern P_P2p2_T P2p2_P;

/* Block signals (auto storage) */
extern B_P2p2_T P2p2_B;

/* Continuous states (auto storage) */
extern X_P2p2_T P2p2_X;

/* Block states (auto storage) */
extern DW_P2p2_T P2p2_DW;

/* Model entry point functions */
extern void P2p2_initialize(void);
extern void P2p2_output(void);
extern void P2p2_update(void);
extern void P2p2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P2p2_T *const P2p2_M;
 ...
 * '<Root>' : 'P2p2'
 * '<S1>'   : 'P2p2/Conversion'
 * '<S2>'   : 'P2p2/Elevation controller'
 * '<S3>'   : 'P2p2/Heli 3D'
 * '<S4>'   : 'P2p2/Joystick'
 * '<S5>'   : 'P2p2/P-controller, travel rate'
 * '<S6>'   : 'P2p2/Pitch controller'
 * '<S7>'   : 'P2p2/Elevation controller/Elevation controller'
 * '<S8>'   : 'P2p2/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'P2p2/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'P2p2/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'P2p2/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'P2p2/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'P2p2/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P2p2_h_ */
