...
MODEL                = P2p2
MODULES              = P2p2_data.c P2p2_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P2p2.mk
...
MODELLIB                  = P2p2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P2p2_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\pamarton\Desktop\HELIKO~1\MATLAB\PART4~1\PROBLE~1
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P2p2_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\pamarton\Desktop\HELIKO~1\MATLAB\PART2~1\PROBLE~2\Tested
