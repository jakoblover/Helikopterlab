...
#endif                                 /* P4p3_COMMON_INCLUDES_ */

#include "P4p3_types.h"
...
#define P4p3_rtModel                   RT_MODEL_P4p3_T
...
#define rtB                            P4p3_B
#define BlockIO                        B_P4p3_T
#define rtX                            P4p3_X
#define ContinuousStates               X_P4p3_T
#define rtXdot                         P4p3_XDot
#define StateDerivatives               XDot_P4p3_T
#define tXdis                          P4p3_XDis
#define StateDisabled                  XDis_P4p3_T
#define rtP                            P4p3_P
#define Parameters                     P_P4p3_T
#define rtDWork                        P4p3_DW
#define D_Work                         DW_P4p3_T
...
extern P_P4p3_T P4p3_P;

/* Block signals (auto storage) */
extern B_P4p3_T P4p3_B;

/* Continuous states (auto storage) */
extern X_P4p3_T P4p3_X;

/* Block states (auto storage) */
extern DW_P4p3_T P4p3_DW;

/* Model entry point functions */
extern void P4p3_initialize(void);
extern void P4p3_output(void);
extern void P4p3_update(void);
extern void P4p3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P4p3_T *const P4p3_M;
 ...
 * '<S2>'   : 'P4p3/Heli 3D'
 * '<S3>'   : 'P4p3/Joystick1'
 * '<S4>'   : 'P4p3/LQR controller1'
 * '<S5>'   : 'P4p3/Linear Observer'
 * '<S6>'   : 'P4p3/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'P4p3/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'P4p3/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'P4p3/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'P4p3/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'P4p3/Heli 3D/Travel rate  rad to deg'
 * '<S12>'  : 'P4p3/Joystick1/Controll Buttons'
 */
#endif                                 /* RTW_HEADER_P4p3_h_ */
