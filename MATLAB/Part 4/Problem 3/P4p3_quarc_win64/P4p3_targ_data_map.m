  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(14).dtTransOffset = 82;
	
	  ;% P4p3_P.HILInitialize_final_pwm_outputs
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 83;
	  ...
	  section.data(17).dtTransOffset = 85;
	
	  ;% P4p3_P.HILInitialize_pwm_frequency
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 86;
	  ...
	  section.data(20).dtTransOffset = 88;
	
	  ;% P4p3_P.HILInitialize_set_other_outputs
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 89;
	
	  ;% P4p3_P.HILInitialize_set_other_outpu_i
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 90;
	
	  ;% P4p3_P.HILInitialize_set_other_outpu_k
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 91;
	
	  ;% P4p3_P.HILInitialize_set_other_outpu_o
	  section.data(24).logicalSrcIdx = 23;
	  section.data(24).dtTransOffset = 92;
	
	  ;% P4p3_P.HILInitialize_watchdog_analog_o
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 93;
	  ...
	  ;% P4p3_P.HILInitialize_set_analog_inpu_o
	  ...
	  ;% P4p3_P.HILInitialize_set_analog_outp_d
	  ...
	  ;% P4p3_P.HILInitialize_set_analog_outp_k
	  section.data(9).logicalSrcIdx = 50;
	  section.data(9).dtTransOffset = 8;
	
	  ;% P4p3_P.HILInitialize_set_analog_outp_h
	  section.data(10).logicalSrcIdx = 51;
	  section.data(10).dtTransOffset = 9;
	
	  ;% P4p3_P.HILInitialize_set_analog_outp_l
	  section.data(11).logicalSrcIdx = 52;
	  section.data(11).dtTransOffset = 10;
	
	  ;% P4p3_P.HILInitialize_set_analog_outp_o
	  ...
	  ;% P4p3_P.HILInitialize_set_clock_frequ_l
	  ...
	  ;% P4p3_P.HILInitialize_set_clock_param_a
	  ...
	  ;% P4p3_P.HILInitialize_set_digital_out_p
	  section.data(20).logicalSrcIdx = 61;
	  section.data(20).dtTransOffset = 19;
	
	  ;% P4p3_P.HILInitialize_set_digital_out_g
	  section.data(21).logicalSrcIdx = 62;
	  section.data(21).dtTransOffset = 20;
	
	  ;% P4p3_P.HILInitialize_set_digital_ou_gs
	  section.data(22).logicalSrcIdx = 63;
	  section.data(22).dtTransOffset = 21;
	
	  ;% P4p3_P.HILInitialize_set_digital_ou_pm
	  ...
	  ;% P4p3_P.HILInitialize_set_encoder_cou_g
	  ...
	  ;% P4p3_P.HILInitialize_set_encoder_par_k
	  section.data(27).logicalSrcIdx = 68;
	  section.data(27).dtTransOffset = 26;
	
	  ;% P4p3_P.HILInitialize_set_other_outp_kp
	  ...
	  ;% P4p3_P.HILInitialize_set_pwm_outputs_c
	  section.data(30).logicalSrcIdx = 71;
	  section.data(30).dtTransOffset = 29;
	
	  ;% P4p3_P.HILInitialize_set_pwm_output_c4
	  ...
	  ;% P4p3_P.HILInitialize_set_pwm_params__m
	  ...
	  ;% P4p3_P.Constant3_Value
	  section.data(4).logicalSrcIdx = 80;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P4p3_P.Constant1_Value
	  section.data(5).logicalSrcIdx = 81;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P4p3_P.Constant2_Value
	  ...
	  ;% P4p3_P.Constant_Value
	  section.data(17).logicalSrcIdx = 93;
	  section.data(17).dtTransOffset = 16;
	
	  ;% P4p3_P.DegtoRad_Gain_k
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p3_DW.ToFile_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 12;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p3_DW.ToFile1_PWORK.FilePtr
	  section.data(2).logicalSrcIdx = 13;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P4p3_DW.ToFile2_PWORK.FilePtr
	  section.data(3).logicalSrcIdx = 14;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P4p3_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 15;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P4p3_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 16;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P4p3_DW.PitchScoperad_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 17;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P4p3_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P4p3_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 19;
	  section.data(8).dtTransOffset = 7;
	
	  ;% P4p3_DW.TravelScoperad_PWORK.LoggedData
	  ...
	  ;% P4p3_DW.ToFile_IWORK.Count
	  section.data(1).logicalSrcIdx = 32;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P4p3_DW.ToFile1_IWORK.Count
	  section.data(2).logicalSrcIdx = 33;
	  section.data(2).dtTransOffset = 1;
	
	  ;% P4p3_DW.ToFile2_IWORK.Count
  ...
  targMap.checksum0 = 102282108;
  targMap.checksum1 = 2983720030;
  targMap.checksum2 = 2631362075;
  targMap.checksum3 = 594714787;
