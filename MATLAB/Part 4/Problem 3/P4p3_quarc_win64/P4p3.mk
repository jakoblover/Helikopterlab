...
MODEL                = P4p3
MODULES              = P4p3_data.c P4p3_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P4p3.mk
...
MODELLIB                  = P4p3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P4p3_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\pamarton\Desktop\HELIKO~1\MATLAB\PART4~1\PROBLE~2
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P4p3_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Tested
