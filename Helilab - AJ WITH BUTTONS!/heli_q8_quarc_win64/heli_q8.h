...
typedef struct {
  ...
  real_T DegtoRad_d;                   /* '<S2>/Deg to Rad  ' */
  real_T PitchCounttorad;              /* '<S2>/Pitch: Count to rad' */
  real_T DegtoRad_k;                   /* '<S2>/Deg to Rad   ' */
  real_T DegtoRad_di;                  /* '<S2>/Deg to Rad    ' */
  real_T ElevationCounttorad;          /* '<S2>/Elevation: Count to rad' */
  real_T DegtoRad_kp;                  /* '<S2>/Deg to Rad     ' */
  real_T DegtoRad_m;                   /* '<S2>/Deg to Rad      ' */
  real_T Joystick_gain_x;              /* '<S3>/Joystick_gain_x' */
  real_T GOUP;                         /* '<S3>/GO UP' */
...
struct P_heli_q8_T_ {
  ...
  real_T Gain_Gain_l;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T DegtoRad_Gain_j;              /* Expression: pi/180
                                        * Referenced by: '<S2>/Deg to Rad  '
                                        */
  ...
  real_T Gain_Gain_ae;                 /* Expression: 180/pi
                                        ...
                                        */
  real_T DegtoRad_Gain_mo;             /* Expression: pi/180
                                        * Referenced by: '<S2>/Deg to Rad    '
                                        */
  ...
  real_T Constant_Value;               /* Expression: -30
                                        ...
                                        */
  real_T DegtoRad_Gain_b;              /* Expression: pi/180
                                        * Referenced by: '<S2>/Deg to Rad     '
                                        */
...
extern void heli_q8_output(void);
extern void heli_q8_update(void);
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/Joystick'
 * '<S4>'   : 'heli_q8/LQR controller'
 * '<S5>'   : 'heli_q8/Heli 3D/Elevation rad to deg'
 * '<S6>'   : 'heli_q8/Heli 3D/Elevation rate rad to deg'
 * '<S7>'   : 'heli_q8/Heli 3D/Pitch rad to deg'
 * '<S8>'   : 'heli_q8/Heli 3D/Pitch rate rad to deg'
 * '<S9>'   : 'heli_q8/Heli 3D/Travel rad to deg'
 * '<S10>'  : 'heli_q8/Heli 3D/Travel rate  rad to deg'
 */
